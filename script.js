...
const GOOGLE_APPS_SCRIPT_URL = "https://script.google.com/macros/s/AKfycbwKVQ_iv8OUVv-QIapTJiPXoKD4NdpFZKOVFXyDqGroJuLckyO7wK7vDU3AT6iRN1RQ/exec"; // ganti dengan URL Web App kamu
...
            renderPropertiTable(); 
            
            // 4. Jika di Form 2 atau 3, render ulang analisis
            if (document.getElementById("analisisDataTable")) renderAnalisisTable();
            if (analisisTable3) renderAnalisisTable3();
...
                };
                ...
                // 🌟 PERBAIKAN: Update data lokal segera untuk feedback instan.
...
            // 🔹 Kirim tambah ke Google Sheets (fungsi ini sudah mengirim action: insert)
...
    modalContainer.className = 'fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full flex items-center justify-center z-50'; // Tambah z-50
...
    const storedPropertis = propertis || []; // Gunakan propertis global yang sudah di-load
...
    const storedPropertis = propertis || []; // Gunakan propertis global yang sudah di-load
    // Pastikan gradeInputJudul ada sebelum mencoba mendapatkan nilainya
    const targetGrade = gradeInputJudul ? parseInt(gradeInputJudul.value) : 1; 
